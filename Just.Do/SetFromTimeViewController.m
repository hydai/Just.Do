...
#import "SetFromTimeViewController.h"
#import "AppDelegate.h"
@interface SetFromTimeViewController ()

@end

@implementation SetFromTimeViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"SetFromTimeReturn"]) {
        ...
        NSDate *getDate = FromTimePicker.date;
        ...
        [newManagedObject setValue:[NSNumber numberWithInt:1] forKey:@"type"];
        // Save the context.
        NSError *error = nil;
